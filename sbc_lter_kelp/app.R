...
#first 2010
santa_rosa_kelp_2010 <- read_csv("data/biomass_files/santa_rosa_kelp_2010.csv")
...
# then 2015
santa_rosa_kelp_2015 <- read_csv("data/biomass_files/santa_rosa_kelp_2015.csv")
...
#then 2020
santa_rosa_kelp_2020 <- read_csv("data/biomass_files/santa_rosa_kelp_2020.csv")
...
#first 2010
sb_kelp_2010 <- read_csv("data/biomass_files/coast_biomass_2010.csv")
...
# then 2015
sb_kelp_2015 <- read_csv("data/biomass_files/coast_biomass_2015.csv")
...
#then 2020
sb_kelp_2020 <- read_csv("data/biomass_files/coast_biomass_2020.csv")
...
santa_rosa_kelp_all_years <- read_csv("data/biomass_files/santa_rosa_kelp_all_years.csv") %>% 
  group_by(year) %>% 
...
sb_kelp_all_years <- read_csv("data/biomass_files/coast_biomass_all_years.csv") %>% 
  group_by(year) %>% 
  summarize(biomass = mean(biomass, na.rm = T))
...
temp_day_sub <- read_csv("data/daily_avg_temp.csv")
kelp_density <- read_csv("data/Annual_All_Species_Biomass_at_transect_20210108.csv")

kelp_factors <- read_csv("data/kelp_no3_waves.csv")
kelp_abund <- read_csv("data/annual_kelp.csv")
...
## Fish:
fish <- read_csv("data/fish_abund.csv")
...
## Invert:
inverts <- read_csv("data/inverts_abund.csv")
        ...
        tabPanel("Project Overview", # Setting project description page
          ...
          column(10, 
                   strong("Kelp forests throughout California are facing multiple threats due to climate change. 
                    ...
                    br(),
                    br(),
                    strong("App Architects:"),
                    tags$a(href="https://connermuir.github.io/connermuir/", 
                        "Conner Smith"),
                    " and ",
                    tags$a(href="https://sachikolamen.github.io/term_project/", 
                        "Sachiko Lamen"),
                    br(),
                    br(),
